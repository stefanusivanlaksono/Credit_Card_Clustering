...
There are also some <a href="https://www.infinitiresearch.com/thoughts/benefits-of-market-segmentation">benefits of customer's segmentation</a>. When we segment our market, we could identify new market opportunities, improve marketing initiatives, devise new pricing strategies, understand the needs of the customers. So, we try to create our customer's segmen based on their behavior.

PWDK Bank is one of the credit card issuers in the USA. PWDK Bank want to increase their profit from its credit card selling. Currently, PWDK Bank only has one type of credit card. They plan to make a few new type of credit card. PWDK Bank already know that it is important to increase profit based on customer loyalty. So, PWDK Bank plan to make customer segmentation based on the customers needs. To get to know the customer's need PWDK bank try to cluster it's customers. We were assigned to the marketing team to help them segment the customers based on their credit card transaction in the past 6 months. 
